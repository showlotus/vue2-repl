...
function ps(e) {
  return e instanceof vs
    ? !0
    : e instanceof Error && e.name === Dt && e.message === Dt
}
class vs extends Error {
  constructor() {
    super(Dt), (this.name = this.message)
  }
}
...
;(function (e) {
  ...
  function h(w, b, C = 100, A = !1, k = !1, D, B) {
    ...
    const ms = {
        ...
        onWillAddFirstListener() {
          X = w((gs) => {
            at++,
              ...
              typeof C == 'number'
                ? (clearTimeout(De), (De = setTimeout(ye, C)))
                : De === void 0 && ((De = 0), queueMicrotask(ye))
          })
        },
      ...
      ot = new ae(ms)
    return B == null || B.add(ot), ot.event
  }
  e.debounce = h
  function d(w, b = 0, C) {
    return e.debounce(
  ...
  function _(w, b, C = (A) => A) {
    const A = (...X) => B.fire(C(...X)),
      ...
      B = new ae({ onWillAddFirstListener: k, onDidRemoveLastListener: D })
    return B.event
  }
  ...
  function j(w) {
    return (b, C, A) => {
      ...
      return A instanceof Qe ? A.add(X) : Array.isArray(A) && A.push(X), X
    }
  }
...
class As {
  ...
  check(t, n) {
    ...
    if (
      ...
      let i,
        o = 0
      for (const [l, u] of this._stacks) (!i || o < u) && ((i = l), (o = u))
      console.warn(
...
class rn {
  static create() {
    var t
    return new rn((t = new Error().stack) !== null && t !== void 0 ? t : '')
  }
  constructor(t) {
    this.value = t
  }
...
class ae {
    ...
    ;(this._size = 0),
      ...
      (this._perfMon =
        !((i = this._options) === null || i === void 0) && i._profName
          ? new Oe(this._options._profName)
          : void 0),
      (this._deliveryQueue =
        (o = this._options) === null || o === void 0 ? void 0 : o.deliveryQueue)
  }
  dispose() {
    var t, n, r, s
    this._disposed ||
      ...
      ((t = this._event) !== null && t !== void 0) ||
        (this._event = (n, r, s) => {
          ...
          this._leakageMon &&
            ...
            this._listeners
              ? this._listeners instanceof Ct
                ? (((c = this._deliveryQueue) !== null && c !== void 0) ||
                    (this._deliveryQueue = new ys()),
          ...
          return s instanceof Qe ? s.add(d) : Array.isArray(s) && s.push(d), d
        }),
      this._event
    )
  }
  ...
  fire(t) {
    ...
    if (
      ...
      if (this._listeners instanceof Ct) this._deliver(this._listeners, t)
      else {
...
;(function () {
  try {
    typeof setTimeout == 'function' ? (ue = setTimeout) : (ue = It)
  } catch {
    ue = It
  }
  try {
    typeof clearTimeout == 'function' ? (ce = clearTimeout) : (ce = Bt)
  } catch {
    ce = Bt
  }
})()
...
function Ps(e) {
  ...
  if ((ce === Bt || !ce) && clearTimeout)
    return (ce = clearTimeout), clearTimeout(e)
  try {
    return ce(e)
  } catch {
    try {
...
function Ds() {
  !He ||
    !Ee ||
    ((He = !1), Ee.length ? (ge = Ee.concat(ge)) : (ct = -1), ge.length && Xr())
}
function Xr() {
  if (!He) {
    var e = jr(Ds)
    ...
    for (var t = ge.length; t; ) {
      for (Ee = ge, ge = []; ++ct < t; ) Ee && Ee[ct].run()
      ;(ct = -1), (t = ge.length)
    }
    ;(Ee = null), (He = !1), Ps(e)
  }
...
O.nextTick = function (e) {
  ...
  ge.push(new Qr(e, t)), ge.length === 1 && !He && jr(Xr)
}
function Qr(e, t) {
...
O.off = xe
O.removeListener = xe
O.removeAllListeners = xe
O.emit = xe
O.prependListener = xe
O.prependOnceListener = xe
...
const Me = globalThis
let J
typeof Me.vscode < 'u' && typeof Me.vscode.process < 'u'
  ? (J = Me.vscode.process)
  : typeof me < 'u' &&
    typeof ((At = me == null ? void 0 : me.versions) === null || At === void 0
      ? void 0
      : At.node) == 'string' &&
    (J = me)
const qs =
    typeof ((Rt = J == null ? void 0 : J.versions) === null || Rt === void 0
      ? void 0
      : Rt.electron) == 'string',
  Us = qs && (J == null ? void 0 : J.type) === 'renderer'
if (typeof J == 'object') {
  ;(qt = J.platform === 'win32'),
    (Ut = J.platform === 'darwin'),
    (yt = J.platform === 'linux'),
    yt && J.env.SNAP && J.env.SNAP_REVISION,
    J.env.CI || J.env.BUILD_ARTIFACTSTAGINGDIRECTORY,
    (lt = qe),
    (Et = qe)
  ...
  if (e)
    try {
      ...
      ;(lt = t.locale),
        (cn = t.osLocale),
        (Et = n || qe),
        (Bs = t._translationsConfigFile)
    } catch {}
} else
  typeof navigator == 'object' && !Us
    ? ((ie = navigator.userAgent),
      (qt = ie.indexOf('Windows') >= 0),
      (Ut = ie.indexOf('Macintosh') >= 0),
      (ie.indexOf('Macintosh') >= 0 ||
        ie.indexOf('iPad') >= 0 ||
        ie.indexOf('iPhone') >= 0) &&
        navigator.maxTouchPoints &&
        navigator.maxTouchPoints > 0,
      (yt = ie.indexOf('Linux') >= 0),
      (ie == null ? void 0 : ie.indexOf('Mobi')) >= 0,
      W({ key: 'ensureLoaderPluginIsLoaded', comment: ['{Locked}'] }, '_'),
      (lt = qe),
      (Et = lt),
      (cn = navigator.language))
    : console.error('Unable to resolve platform.')
const tt = qt,
  Hs = Ut,
  de = ie,
  Ws = typeof Me.postMessage == 'function' && !Me.importScripts
;(() => {
  if (Ws) {
    const e = []
...
const zs = !!(de && de.indexOf('Chrome') >= 0)
de && de.indexOf('Firefox') >= 0
!zs && de && de.indexOf('Safari') >= 0
de && de.indexOf('Edg/') >= 0
...
Ge = Pe
Pe.ambiguousCharacterData = new Jr(() =>
  JSON.parse(
...
Pe.cache = new Os({ getCacheKey: JSON.stringify }, (e) => {
  function t(c) {
    const f = new Map()
...
class ai {
  ...
  sendMessage(t, n) {
    ...
    return new Promise((s, i) => {
      ;(this._pendingReplies[r] = { resolve: s, reject: i }),
        this._send(new ni(this._workerId, r, t, n))
    })
  }
  listen(t, n) {
    let r = null
    const s = new ae({
      onWillAddFirstListener: () => {
        ;(r = String(++this._lastSentReq)),
          ...
          this._send(new ri(this._workerId, r, t, n))
      },
      onDidRemoveLastListener: () => {
        this._pendingEmitters.delete(r),
          this._send(new ii(this._workerId, r)),
          (r = null)
      },
    })
    return s.event
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.method, t.args).then(
      (s) => {
        this._send(new hn(this._workerId, n, s, void 0))
      },
      (s) => {
        s.detail instanceof Error && (s.detail = un(s.detail)),
          this._send(new hn(this._workerId, n, void 0, un(s)))
      },
    )
  }
  _handleSubscribeEventMessage(t) {
    const n = t.req,
      r = this._handler.handleEvent(
        ...
        this._send(new si(this._workerId, n, s))
      })
...
function Zr(e) {
  return e[0] === 'o' && e[1] === 'n' && Yr(e.charCodeAt(2))
}
function Kr(e) {
  return /^onDynamic/.test(e) && Yr(e.charCodeAt(9))
}
function oi(e, t, n) {
  const r = (o) =>
      function () {
...
class li {
  ...
  _handleMessage(t, n) {
    if (t === ti) return this.initialize(n[0], n[1], n[2], n[3])
  ...
  initialize(t, n, r, s) {
    ...
    return this._requestHandlerFactory
      ? ((this._requestHandler = this._requestHandlerFactory(l)),
        Promise.resolve(Vt(this._requestHandler)))
      : (n &&
        ...
        new Promise((u, c) => {
          ...
          f(
            ...
            (h) => {
              if (
                ((this._requestHandler = h.create(l)), !this._requestHandler)
              ) {
                c(new Error('No RequestHandler!'))
                return
              }
              u(Vt(this._requestHandler))
            },
            c,
          )
        }))
...
function ui(e, t) {
  t = fn(149417, t)
  for (let n = 0, r = e.length; n < r; n++) t = fn(e.charCodeAt(n), t)
  return t
}
class dn {
  constructor(t) {
...
function ci(e, t, n) {
  return new Le(new dn(e), new dn(t)).ComputeDiff(n).changes
}
class Te {
  static Assert(t, n) {
...
class Le {
  constructor(t, n, r = null) {
    ...
    const [s, i, o] = Le._getElements(t),
      [l, u, c] = Le._getElements(n)
  ...
  static _getElements(t) {
    ...
    if (Le._isStringArray(n)) {
      ...
      for (let s = 0, i = n.length; s < i; s++) r[s] = ui(n[s], 0)
      return [n, r, !0]
    }
  ...
  ElementsAreStrictEqual(t, n) {
    ...
    const r = Le._getStrictElement(this._originalSequence, t),
      s = Le._getStrictElement(this._modifiedSequence, n)
    return r === s
  }
  ...
  ComputeDiffRecursive(t, n, r, s, i) {
    ...
    if (!i[0]) {
      ...
      return (
        i[0]
          ? (d = [new we(c + 1, n - (c + 1) + 1, f + 1, s - (f + 1) + 1)])
  ...
  WALKTRACE(t, n, r, s, i, o, l, u, c, f, h, d, m, g, x, v, N, S) {
    let _ = null,
      L = null,
      p = new mn(),
      R = n,
  ...
  ComputeRecursionPoint(t, n, r, s, i, o, l) {
    ...
    for (let E = 1; E <= g / 2 + 1; E++) {
      ...
      if (E <= 1447) {
        ...
        ;(b[0] = S - f + 1),
          Ve.Copy2(v, f, b, 1, h - f + 1),
          this.m_forwardHistory.push(b),
          (b = new Int32Array(m - d + 2)),
          (b[0] = _ - d + 1),
          Ve.Copy2(N, d, b, 1, m - d + 1),
          this.m_reverseHistory.push(b)
      }
    }
    return this.WALKTRACE(S, f, h, L, _, d, m, p, v, N, u, n, i, c, s, o, y, l)
  }
  PrettifyChanges(t) {
  ...
  ConcatenateChanges(t, n) {
    ...
    if (this.ChangesOverlap(t[t.length - 1], n[0], r)) {
      ...
      return (
        Ve.Copy(t, 0, s, 0, t.length - 1),
        (s[t.length - 1] = r[0]),
        Ve.Copy(n, 1, s, t.length, n.length - 1),
        s
      )
    } else {
      const s = new Array(t.length + n.length)
      return (
        Ve.Copy(t, 0, s, 0, t.length), Ve.Copy(n, 0, s, t.length, n.length), s
      )
    }
  }
...
if (typeof Mt < 'u' && typeof Mt.process < 'u') {
  ...
  typeof me < 'u'
    ? (We = {
        ...
        cwd() {
          return gn.VSCODE_CWD || me.cwd()
        },
      })
    : (We = {
        get platform() {
          return tt ? 'win32' : Hs ? 'darwin' : 'linux'
        },
        get arch() {},
        get env() {
          return {}
...
function xi(e, t) {
  if (e === null || typeof e != 'object') throw new es(t, 'Object', e)
}
function $(e, t) {
  if (typeof e != 'string') throw new es(t, 'string', e)
}
const Re = fi === 'win32'
function P(e) {
  return e === Q || e === ee
      ...
      if (!(o === c - 1 || l === 1))
        if (l === 2) {
          if (
            s.length < 2 ||
            i !== 2 ||
            s.charCodeAt(s.length - 1) !== Se ||
            s.charCodeAt(s.length - 2) !== Se
          ) {
            if (s.length > 2) {
...
const K = {
    resolve(...e) {
      ...
      for (let s = e.length - 1; s >= -1; s--) {
        ...
        if (r) {
          if (t.length > 0) break
        } else if (((n = `${i.slice(l)}\\${n}`), (r = c), c && t.length > 0))
          break
      }
      return (n = pt(n, !r, '\\', P)), r ? `${t}\\${n}` : `${t}${n}` || '.'
    },
    normalize(e) {
      $(e, 'path')
      const t = e.length
    ...
    isAbsolute(e) {
      ...
      return (
        P(n) || (t > 2 && ve(n) && e.charCodeAt(1) === pe && P(e.charCodeAt(2)))
      )
    },
    join(...e) {
    ...
    relative(e, t) {
      ...
      if (d !== f) {
        ...
        o > f && (e.charCodeAt(s + d) === ee ? (h = d) : d === 2 && (h = 3)),
          h === -1 && (h = 0)
      }
      let m = ''
      for (d = s + h + 1; d <= i; ++d)
        (d === i || e.charCodeAt(d) === ee) &&
          (m += m.length === 0 ? '..' : '\\..')
      return (
        (l += h),
        m.length > 0
          ? `${m}${r.slice(l, u)}`
          : (r.charCodeAt(l) === ee && ++l, r.slice(l, u))
      )
    },
    toNamespacedPath(e) {
      ...
      if (t.charCodeAt(0) === ee) {
        if (t.charCodeAt(1) === ee) {
          ...
          if (n !== _i && n !== Se) return `\\\\?\\UNC\\${t.slice(2)}`
        }
      } else if (
        ve(t.charCodeAt(0)) &&
        t.charCodeAt(1) === pe &&
  ...
  te = {
    resolve(...e) {
      ...
      for (let r = e.length - 1; r >= -1 && !n; r--) {
        const s = r >= 0 ? e[r] : pi()
        $(s, 'path'),
          s.length !== 0 && ((t = `${s}/${t}`), (n = s.charCodeAt(0) === Q))
      }
      return (t = pt(t, !n, '/', Wt)), n ? `/${t}` : t.length > 0 ? t : '.'
    },
    normalize(e) {
    ...
    relative(e, t) {
      if (
        ($(e, 'from'),
        $(t, 'to'),
        e === t || ((e = te.resolve(e)), (t = te.resolve(t)), e === t))
      )
        return ''
      const n = 1,
        r = e.length,
      ...
      if (c === l)
        if (o > l) {
          if (t.charCodeAt(i + c) === Q) return t.slice(i + c + 1)
          if (c === 0) return t.slice(i + c)
        } else
          s > l && (e.charCodeAt(n + c) === Q ? (u = c) : c === 0 && (u = 0))
      let f = ''
      for (c = n + u + 1; c <= r; ++c)
        (c === r || e.charCodeAt(c) === Q) &&
          (f += f.length === 0 ? '..' : '/..')
...
te.win32 = K.win32 = K
te.posix = K.posix = te
Re ? K.normalize : te.normalize
Re ? K.resolve : te.resolve
Re ? K.relative : te.relative
Re ? K.dirname : te.dirname
Re ? K.basename : te.basename
Re ? K.extname : te.extname
Re ? K.sep : te.sep
const vi = /^\w[\w\d+.-]*$/,
  wi = /^\//,
  Li = /^\/\//
...
class ke {
  ...
  with(t) {
    ...
    return (
      ...
      o === void 0 ? (o = this.fragment) : o === null && (o = H),
      n === this.scheme &&
      r === this.authority &&
      s === this.path &&
      i === this.query &&
  ...
  static file(t) {
    ...
    if ((tt && (t = t.replace(/\\/g, oe)), t[0] === oe && t[1] === oe)) {
      ...
      r === -1
        ...
        : ((n = t.substring(2, r)), (t = t.substring(r) || oe))
    }
    return new Ie('file', n, t, H, H)
  }
  static from(t, n) {
    return new Ie(t.scheme, t.authority, t.path, t.query, t.fragment, n)
  }
  static joinPath(t, ...n) {
    if (!t.path)
    ...
    return (
      tt && t.scheme === 'file'
        ? (r = ke.file(K.join(zt(t, !0), ...n)).path)
        : (r = te.join(t.path, ...n)),
      t.with({ path: r })
    )
  }
    ...
    if (t) {
      if (t instanceof ke) return t
      {
        ...
        return (
          ...
          (s._fsPath =
            t._sep === ns && (r = t.fsPath) !== null && r !== void 0
              ? r
              : null),
          s
        )
...
class Ie extends ke {
  ...
  toJSON() {
    const t = { $mid: 1 }
    return (
      this._fsPath && ((t.fsPath = this._fsPath), (t._sep = ns)),
...
function Ri(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const r = e.charCodeAt(n)
    r === 35 || r === 63
      ? (t === void 0 && (t = e.substr(0, n)), (t += rs[r]))
      : t !== void 0 && (t += e[n])
  }
  return t !== void 0 ? t : e
}
...
function ss(e) {
  try {
    ...
    return e.length > 3 ? e.substr(0, 3) + ss(e.substr(3)) : e
  }
}
const _n = /(%[0-9A-Za-z][0-9A-Za-z])+/g
function ut(e) {
  return e.match(_n) ? e.replace(_n, (t) => ss(t)) : e
}
class Y {
  constructor(t, n) {
  ...
  static plusRange(t, n) {
    ...
    return (
      ...
      n.endLineNumber > t.endLineNumber
        ...
        : n.endLineNumber === t.endLineNumber
          ? ((i = n.endLineNumber), (o = Math.max(n.endColumn, t.endColumn)))
    ...
    for (const r of n)
      this._acceptDeleteRange(r.range),
        this._acceptInsertText(
          new Y(r.range.startLineNumber, r.range.startColumn),
          r.text,
        )
...
function Bi(e = '') {
  let t = '(-?\\d*\\.\\d\\w*)|([^'
  for (const n of Ii) e.indexOf(n) >= 0 || (t += '\\' + n)
...
const os = new Ns()
os.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 })
function sn(e, t, n, r, s) {
  if (((t = as(t)), s || (s = bt.first(os)), n.length > s.maxLen)) {
    let c = e - s.maxLen / 2
    return (
      c < 0 ? (c = 0) : (r += c),
...
class an {
  constructor(t) {
    ...
    ;(this._defaultValue = n),
      (this._asciiMap = an._createAsciiMap(n)),
      (this._map = new Map())
  }
    ...
    for (let i = 1, o = t.getLineCount(); i <= o; i++) {
      ...
      for (; c < u; ) {
        ...
        if (d === 13) {
          ...
          _ === 1 && (s.push(vt._createLink(r, l, i, f, c)), (N = !0))
        } else if (d === 12) {
          let _
      ...
      d === 13 && s.push(vt._createLink(r, l, i, f, u))
    }
    return s
  }
}
...
;(function (e) {
  function t(n) {
    return n === e.None || n === e.Cancelled || n instanceof dt
      ? !0
      : !n || typeof n != 'object'
        ? !1
  ...
  ;(e.isCancellationToken = t),
    (e.None = Object.freeze({
      ...
      onCancellationRequested: Tt.None,
    })),
...
class dt {
  ...
  get onCancellationRequested() {
    return this._isCancelled
      ? ls
      : (this._emitter || (this._emitter = new ae()), this._emitter.event)
  }
  dispose() {
...
class Oi {
  ...
  cancel() {
    this._token
      ? this._token instanceof dt && this._token.cancel()
      : (this._token = wt.Cancelled)
  }
  dispose(t = !1) {
    var n
    t && this.cancel(),
      ...
      this._token
        ? this._token instanceof dt && this._token.dispose()
        : (this._token = wt.None)
  }
}
class on {
...
;(function () {
  ...
  for (const s of t) {
    ...
    if (
      (r[o] || ((r[o] = !0), (ji[l] = o), (Xi[l.toLowerCase()] = o)), !n[u])
    ) {
      if (((n[u] = !0), !c))
        throw new Error(
          `String representation missing for key code ${u} around scan code ${l}`,
        )
      mt.define(u, c), Gt.define(u, d || c), jt.define(u, m || d || c)
    }
    f && (Gi[f] = u)
  }
})()
...
;(function (e) {
  ...
  function i(l) {
    return Gt.strToKeyCode(l) || jt.strToKeyCode(l)
  }
...
class ne extends F {
  ...
  setEndPosition(t, n) {
    return this.getDirection() === 0
      ? new ne(this.startLineNumber, this.startColumn, t, n)
      : new ne(t, n, this.startLineNumber, this.startColumn)
  }
  getPosition() {
  ...
  setStartPosition(t, n) {
    return this.getDirection() === 0
      ? new ne(t, n, this.endLineNumber, this.endColumn)
      : new ne(this.endLineNumber, this.endColumn, t, n)
  }
  static fromPositions(t, n = t) {
  ...
  static fromRange(t, n) {
    return n === 0
      ? new ne(t.startLineNumber, t.startColumn, t.endLineNumber, t.endColumn)
      : new ne(t.endLineNumber, t.endColumn, t.startLineNumber, t.startColumn)
  }
...
function la(e, t, n, r, s) {
  return aa(e, t, n, r, s) && oa(e, t, n, r, s)
}
class ua {
  constructor(t, n) {
  ...
  next(t) {
    ...
    do {
      ...
      if (s === this._prevMatchStartIndex && i === this._prevMatchLength) {
        if (i === 0) {
          Zs(t, n, this._searchRegex.lastIndex) > 65535
      ...
      if (
        ...
        !this._wordSeparators || la(this._wordSeparators, t, n, s, i))
      )
        return r
    } while (r)
    return null
...
function ca(e, t = 'Unreachable') {
  throw new Error(t)
}
function Lt(e) {
  if (!e()) {
    debugger
    e(), $r(new fe('Assertion Failed'))
  }
}
function us(e, t) {
  let n = 0
...
class ha {
  static computeUnicodeHighlights(t, n, r) {
    ...
    l === 'allNonBasicAscii'
      ? (u = new RegExp('[^\\t\\n\\r\\x20-\\x7E]', 'g'))
      : (u = new RegExp(`${fa(Array.from(l))}`, 'g'))
    const c = new ua(null, u),
      f = []
    let h = !1,
      d,
      m = 0,
    ...
    switch (r.shouldHighlightNonBasicASCII(t, null)) {
      ...
      case 3: {
        const i = t.codePointAt(0),
          ...
          l = Pe.getLocales().filter(
            (u) =>
              !Pe.getInstance(new Set([...n.allowedLocales, u])).isAmbiguous(i),
          )
        return {
          kind: 0,
...
function fa(e, t) {
  return `[${Gs(e.map((r) => String.fromCodePoint(r)).join(''))}]`
}
class Ar {
  constructor(t) {
    ;(this.options = t),
      (this.allowedCodePoints = new Set(t.allowedCodePoints)),
      (this.ambiguousCharacters = Pe.getInstance(new Set(t.allowedLocales)))
  }
  getCandidateCodePoints() {
    if (this.options.nonBasicASCII) return 'allNonBasicAscii'
    const t = new Set()
    if (this.options.invisibleCharacters)
      for (const n of Ne.codePoints) Rr(String.fromCodePoint(n)) || t.add(n)
      ...
      for (const o of n) {
        ...
        ;(s = s || u),
          !u &&
            ...
            !Ne.isInvisibleCharacter(l) &&
            (i = !0)
      }
    return !s && i
      ? 0
      : this.options.invisibleCharacters && !Rr(t) && Ne.isInvisibleCharacter(r)
        ? 2
...
class V {
  ...
  clip(t) {
    if (this.isEmpty) throw new fe(`Invalid clipping range: ${this.toString()}`)
...
function nt(e, t, n = 0, r = e.length) {
  let s = n,
    i = r
  for (; s < i; ) {
...
class T {
  ...
  static joinMany(t) {
    ...
    for (let r = 1; r < t.length; r++) n = n.getUnion(new he(t[r].slice()))
    return n.ranges
  }
  static join(t) {
    if (t.length === 0) throw new fe('lineRanges cannot be empty')
...
class he {
  ...
  subtractFrom(t) {
    ...
    for (let o = n; o < r; o++) {
      ...
      l.startLineNumber > i && s.push(new T(i, l.startLineNumber)),
...
class le {
  ...
  static clip(t, n, r) {
    ...
    for (const i of t) {
      ...
      o && !o.isEmpty && l && !l.isEmpty && s.push(new le(o, l))
    }
    return s
  }
  constructor(t, n) {
...
class Ce {
  ...
  toTextEdit(t) {
    ...
    return new ga(this.originalRange, n)
  }
}
const ba = 3
class _a {
  computeDiff(t, n, r) {
    ...
    return (
      ...
      new gt(l, [], o.quitEarly)
    )
  }
}
function cs(e, t, n, r) {
  return new Le(e, t, n).ComputeDiff(r)
}
let yr = class {
  constructor(t) {
    const n = [],
  ...
  createCharSequence(t, n, r) {
    ...
    for (let u = n; u <= r; u++) {
      ...
      for (let d = f; d < h; d++)
        (s[l] = c.charCodeAt(d - 1)), (i[l] = u + 1), (o[l] = d), l++
      !t && u < r && ((s[l] = 10), (i[l] = u + 1), (o[l] = c.length + 1), l++)
    }
    return new xa(s, i, o)
  }
}
  ...
  static createFromDiffResult(t, n, r, s, i, o, l) {
    ...
    if (
      ...
      if (m.getElements().length > 0 && g.getElements().length > 0) {
        let x = cs(m, g, i, !0).changes
        l && (x = pa(x)), (d = [])
        for (let v = 0, N = x.length; v < N; v++)
          d.push(ze.createFromDiffChange(x[v], m, g))
      }
    }
    return new Ke(u, c, f, h, d)
  }
}
class va {
  constructor(t, n, r) {
    ;(this.shouldComputeCharChanges = r.shouldComputeCharChanges),
      ...
      (this.original = new yr(t)),
      (this.modified = new yr(n)),
      (this.continueLineDiff = Er(r.maxComputationTime)),
      (this.continueCharDiff = Er(
        ...
        if (d !== m) {
          {
            ...
            ;(g > 1 || x > 1) &&
              this._pushTrimWhitespaceCharChange(s, i + 1, 1, g, o + 1, 1, x)
          }
          {
            let g = en(d, 1),
              x = en(m, 1)
            ...
            ;(g < v || x < N) &&
              this._pushTrimWhitespaceCharChange(s, i + 1, g, v, o + 1, x, N)
          }
        }
        i++, o++
      }
  ...
  _pushTrimWhitespaceCharChange(t, n, r, s, i, o, l) {
    if (this._mergeTrimWhitespaceCharChange(t, n, r, s, i, o, l)) return
    let u
    this.shouldComputeCharChanges && (u = [new ze(n, r, n, s, i, o, i, l)]),
      t.push(new Ke(n, n, i, i, u))
  }
  _mergeTrimWhitespaceCharChange(t, n, r, s, i, o, l) {
    ...
    return c.originalEndLineNumber === 0 || c.modifiedEndLineNumber === 0
      ...
      : c.originalEndLineNumber === n && c.modifiedEndLineNumber === i
        ? (this.shouldComputeCharChanges &&
            c.charChanges &&
            c.charChanges.push(new ze(n, r, n, s, i, o, i, l)),
          !0)
...
class _e {
  static trivial(t, n) {
    return new _e([new z(V.ofLength(t.length), V.ofLength(n.length))], !1)
  }
  static trivialTimedOut(t, n) {
    return new _e([new z(V.ofLength(t.length), V.ofLength(n.length))], !0)
  }
  constructor(t, n) {
...
Xe.chrKeys = new Map()
class La {
  compute(t, n, r = rt.instance, s) {
    if (t.length === 0 || n.length === 0) return _e.trivial(t, n)
    const i = new Ft(t.length, n.length),
      o = new Ft(t.length, n.length),
      l = new Ft(t.length, n.length)
    for (let g = 0; g < t.length; g++)
      for (let x = 0; x < n.length; x++) {
        if (!r.isValid()) return _e.trivialTimedOut(t, n)
        ...
        if (_ === S) {
          const L = g > 0 && x > 0 ? l.get(g - 1, x - 1) : 0
          l.set(g, x, L + 1), o.set(g, x, 3)
        } else
          _ === v
            ? (l.set(g, x, 0), o.set(g, x, 1))
            : _ === N && (l.set(g, x, 0), o.set(g, x, 2))
        i.set(g, x, _)
      }
    const u = []
    let c = t.length,
    ...
    return h(-1, -1), u.reverse(), new _e(u, !1)
  }
}
class hs {
  compute(t, n, r = rt.instance) {
    if (t.length === 0 || n.length === 0) return _e.trivial(t, n)
    const s = t,
      i = n
    function o(x, v) {
    ...
    u.set(0, o(0, 0))
    const c = new Sa()
    c.set(0, u.get(0) === 0 ? null : new Mr(null, 0, 0, u.get(0)))
    let f = 0
    e: for (;;) {
      if ((l++, !r.isValid())) return _e.trivialTimedOut(s, i)
      ...
      for (f = x; f <= v; f += 2) {
        ...
        if (
          (c.set(f, p !== _ ? new Mr(R, _, L, p - _) : R),
...
class Nt {
  ...
  getBoundaryScore(t) {
    const n = Fr(t > 0 ? this.elements[t - 1] : -1),
      r = Fr(t < this.elements.length ? this.elements[t] : -1)
    if (n === 7 && r === 8) return 0
    if (n === 8) return 150
    let s = 0
    return (
  ...
  translateOffset(t) {
    if (this.lineRange.isEmpty) return new Y(this.lineRange.start + 1, 1)
    const n = nt(this.firstCharOffsetByLine, (r) => r <= t)
    return new Y(
  ...
  findWordContaining(t) {
    if (t < 0 || t >= this.elements.length || !Pt(this.elements[t])) return
    let n = t
    for (; n > 0 && Pt(this.elements[n - 1]); ) n--
    let r = t
    for (; r < this.elements.length && Pt(this.elements[r]); ) r++
    return new V(n, r)
  }
  countLinesIn(t) {
    return (
  ...
  extendToFullLines(t) {
    var n, r
    const s =
        (n = je(this.firstCharOffsetByLine, (o) => o <= t.start)) !== null &&
        n !== void 0
          ? n
          : 0,
      i =
        (r = ma(this.firstCharOffsetByLine, (o) => t.endExclusive <= o)) !==
          null && r !== void 0
          ? r
          : this.elements.length
    return new V(s, i)
...
const Ca = { 0: 0, 1: 0, 2: 0, 3: 10, 4: 2, 5: 30, 6: 3, 7: 10, 8: 10 }
function kr(e) {
  return Ca[e]
}
function Fr(e) {
...
function Aa(e, t, n, r, s, i) {
  let { moves: o, excludedChanges: l } = ya(e, t, n, i)
  if (!i.isValid()) return []
...
function ya(e, t, n, r) {
  const s = [],
    i = e
      ...
      .map((u) => new Xe(u.original, t, u)),
    o = new Set(
      e
        .filter((u) => u.original.isEmpty && u.modified.length >= 3)
        .map((u) => new Xe(u.modified, n, u)),
    ),
    l = new Set()
  for (const u of i) {
    let c = -1,
...
function Ea(e, t, n, r, s, i) {
  ...
  const u = []
  e.sort(ht((d) => d.modified.startLineNumber, ft))
  for (const d of e) {
    let m = []
    for (
  ...
  u.sort(Pi(ht((d) => d.modifiedLineRange.length, ft)))
  const c = new he(),
    f = new he()
  for (const d of u) {
    const m =
    ...
    for (const N of v.ranges) {
      ...
      const S = N,
        _ = N.delta(-m)
      o.push(new le(_, S)), c.addRange(S), f.addRange(_)
    }
  }
  o.sort(ht((d) => d.original.startLineNumber, ft))
  const h = new it(e)
...
function Pr(e, t, n) {
  ...
  const s = new hs().compute(
    new Nt([e], new V(0, 1), !1),
    new Nt([t], new V(0, 1), !1),
    n,
  )
  let i = 0
  ...
  function l(f) {
    let h = 0
    for (let d = 0; d < e.length; d++) tn(f.charCodeAt(d)) || h++
    return h
  }
...
function Ma(e) {
  ...
  e.sort(ht((n) => n.original.startLineNumber, ft))
  const t = [e[0]]
  ...
  return (
    (t = t.filter((r) => {
      const s =
        ...
        i = je(
          e,
          (l) => l.modified.startLineNumber < r.modified.endLineNumberExclusive,
        )
      return s !== i
    })),
    t
...
function Dr(e, t, n) {
  let r = n
  return (r = Tr(e, t, r)), (r = Tr(e, t, r)), (r = Fa(e, t, r)), r
}
function Tr(e, t, n) {
...
function Fa(e, t, n) {
  ...
  for (let r = 0; r < n.length; r++) {
    ...
    i.seq1Range.isEmpty
      ? (n[r] = Vr(i, e, t, l, u))
      : i.seq2Range.isEmpty && (n[r] = Vr(i.swap(), t, e, u, l).swap())
  }
  return n
}
      ...
      let d = function (g, x) {
        ...
        return (
          Math.pow(
            ...
            Math.pow(
              Math.pow(b(y * 40 + E), 1.5) + Math.pow(b(q * 40 + j), 1.5),
              1.5,
            ) >
          (w ** 1.5) ** 1.5 * 1.3
        )
  ...
  return (
    ki(r, (u, c, f) => {
      ...
      const v = z.fromOffsetPairs(
          u ? u.getEndExclusives() : re.zero,
          f ? f.getStarts() : re.max,
        ),
        N = h.intersect(v)
...
class Ba {
  constructor() {
    ;(this.dynamicProgrammingDiffing = new La()),
      (this.myersDiffingAlgorithm = new hs())
  }
  computeDiff(t, n, r) {
    if (t.length <= 1 && yi(t, n, (p, R) => p === R)) return new gt([], [], !1)
    if (
      ...
      return new gt(
        [
          new be(new T(1, t.length + 1), new T(1, n.length + 1), [
            new Ce(
        ...
        if (i)
          for (let R = 0; R < p; R++) {
            ...
            if (t[y] !== n[E]) {
              ...
              for (const j of q.mappings) x.push(j)
              q.hitTimeout && (g = !0)
            }
          }
      }
    let N = 0,
      S = 0
    for (const p of m) {
      Lt(() => p.seq1Range.start - N === p.seq2Range.start - S)
  ...
  computeMoves(t, n, r, s, i, o, l) {
    return Aa(t, n, r, s, i, o).map((f) => {
      const h = this.refineDiff(
        ...
        d = qr(h.mappings, n, r, !0)
      return new da(f, d)
    })
  }
  refineDiff(t, n, r, s, i) {
    const o = new Nt(t, r.seq1Range, i),
      l = new Nt(n, r.seq2Range, i),
      u =
...
const Ur = { getLegacy: () => new _a(), getDefault: () => new Ba() }
function Ae(e, t) {
...
class se {
  ...
  static fromRGBA(t) {
    ...
    if (h > 0) {
      switch (
        ((c = Math.min(f <= 0.5 ? h / (2 * f) : h / (2 - 2 * f), 1)), o)
      ) {
        case n:
          u = (r - s) / h + (r < s ? 6 : 0)
          break
  ...
  static toRGBA(t) {
    ...
    if (r === 0) o = l = u = s
      ...
      const c = s < 0.5 ? s * (1 + r) : s + r - s * r,
        f = 2 * s - c
      ;(o = se._hue2rgb(f, c, n + 1 / 3)),
        (l = se._hue2rgb(f, c, n)),
        (u = se._hue2rgb(f, c, n - 1 / 3))
    }
    return new G(
      Math.round(o * 255),
      Math.round(l * 255),
...
class I {
  ...
  constructor(t) {
    if (t)
      if (t instanceof G) this.rgba = t
      else if (t instanceof se) (this._hsla = t), (this.rgba = se.toRGBA(t))
  ...
  equals(t) {
    return (
      !!t &&
      G.equals(this.rgba, t.rgba) &&
      se.equals(this.hsla, t.hsla) &&
...
I.white = new I(new G(255, 255, 255, 1))
I.black = new I(new G(0, 0, 0, 1))
I.red = new I(new G(255, 0, 0, 1))
I.blue = new I(new G(0, 0, 255, 1))
I.green = new I(new G(0, 255, 0, 1))
I.cyan = new I(new G(0, 255, 255, 1))
I.lightgrey = new I(new G(211, 211, 211, 1))
I.transparent = new I(new G(0, 0, 0, 0))
;(function (e) {
  ;(function (t) {
    ;(function (n) {
      function r(m) {
      ...
      function h(m) {
        ...
        if (g === 9) {
          ...
          return new e(new G(x, v, N, S / 255))
        }
        if (g === 4) {
          const x = d(m.charCodeAt(1)),
            v = d(m.charCodeAt(2)),
            N = d(m.charCodeAt(3))
          return new e(new G(16 * x + x, 16 * v + v, 16 * N + N))
        }
        if (g === 5) {
          const x = d(m.charCodeAt(1)),
            v = d(m.charCodeAt(2)),
            ...
            S = d(m.charCodeAt(4))
          return new e(
            new G(16 * x + x, 16 * v + v, 16 * N + N, (16 * S + S) / 255),
          )
        }
        return null
      }
...
function Ua(e, t) {
  ...
  if (n) return { range: e, color: ln(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a) }
}
function Hr(e, t, n) {
  if (!e || t.length !== 1) return
  const s = t[0].values(),
    i = fs(s)
  return { range: e, color: ln(i[0], i[1], i[2], n ? i[3] : 1) }
}
function Wr(e, t, n) {
  if (!e || t.length !== 1) return
  const s = t[0].values(),
    i = fs(s),
    o = new I(new se(i[0], i[1] / 100, i[2] / 100, n ? i[3] : 1))
  return { range: e, color: ln(o.rgba.r, o.rgba.g, o.rgba.b, o.rgba.a) }
}
function Ze(e, t) {
...
function ja(e, t, n) {
  ...
  if (r) {
    const s = r.indices[1][0] + 1,
      i = r.indices[1][1] + 1,
      o = { startLineNumber: t, startColumn: s, endLineNumber: t, endColumn: i }
    if (o.endColumn > o.startColumn) {
      const l = { range: o, ...ds(r[1]), shouldBeInComments: !0 }
...
function ds(e) {
  ...
  return (e = e.replace(za, '')), { text: e, hasSeparatorLine: t }
}
class Xa extends Vi {
  get uri() {
    return this._uri
  ...
  getWordAtPosition(t, n) {
    const r = sn(t.column, as(n), this._lines[t.lineNumber - 1], 0)
    return r
      ...
      *[Symbol.iterator]() {
        for (;;)
          if (o < l.length) {
            ...
            ;(o += 1), yield u
          } else if (s < n.length) (i = n[s]), (l = r(i, t)), (o = 0), (s += 1)
          else break
      },
    }
  }
  ...
  _validatePosition(t) {
    if (!Y.isIPosition(t)) throw new Error('bad position')
...
class Fe {
  ...
  acceptNewModel(t) {
    this._models[t.url] = new Xa(ke.parse(t.url), t.lines, t.EOL, t.versionId)
  }
  ...
  async computeUnicodeHighlights(t, n, r) {
    ...
    return s
      ? ha.computeUnicodeHighlights(s, n, r)
      : {
          ranges: [],
          hasMore: !1,
  ...
  async computeDiff(t, n, r, s) {
    const i = this._getModel(t),
      o = this._getModel(n)
    return !i || !o ? null : Fe.computeDiff(i, o, r, s)
  }
  static computeDiff(t, n, r, s) {
    const i = s === 'advanced' ? Ur.getDefault() : Ur.getLegacy(),
      o = t.getLinesContent(),
      l = n.getLinesContent(),
  ...
  async computeMoreMinimalEdits(t, n, r) {
    ...
    for (let u = 1; u < n.length; u++)
      F.getEndPosition(n[l].range).equals(F.getStartPosition(n[u].range))
    ...
    for (let { range: u, text: c, eol: f } of n) {
      if ((typeof f == 'number' && (o = f), F.isEmpty(u) && !c)) continue
      const h = s.getValueInRange(u)
      if (((c = c.replace(/\r\n|\n|\r/g, s.eol)), h === c)) continue
      if (Math.max(c.length, h.length) > Fe._diffLimit) {
    ...
    e: for (const u of t) {
      ...
      if (c) {
        for (const f of c.words(o))
          if (
            !(f === n || !isNaN(Number(f))) &&
            (l.add(f), l.size > Fe._suggestionsLimit)
          )
            break e
      }
    }
  ...
  async navigateValueSet(t, n, r, s, i) {
    ...
    return Ot.INSTANCE.navigateValueSet(n, u, c, f, r)
  }
  loadForeignModule(t, n, r) {
    const o = {
      host: ks(r, (l, u) => this._host.fhr(l, u)),
      getMirrorModels: () => this._getModels(),
    }
    return this._foreignModuleFactory
      ? ((this._foreignModule = this._foreignModuleFactory(o, n)),
        Promise.resolve(Vt(this._foreignModule)))
...
typeof importScripts == 'function' && (globalThis.monaco = ta())
let nn = !1
function Qa(e) {
  if (nn) return
  nn = !0
